...
export function Header() {
  ...
  return (
    <header className="w-full flex items-center justify-between py-6 px-8 container mx-auto outline outline-1 outline-slate-200 relative z-0">
      <div className="flex items-center gap-4">
        ...
        <NavigationMenu className="mt-1">
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger>Sapatos</NavigationMenuTrigger>
              <NavigationMenuContent>
                <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                  {components.map((component) => (
                    <ListItem
